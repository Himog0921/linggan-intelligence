...
function researchOutputFormat(r,base) {
  ...
  const schemaName=packet?.contract==='comment-research.semantic.v1'?'comment_research_semantic_v1':packet?.contract==='comment-research.semantic.v2'?'comment_research_semantic_v2':packet?.contract==='comment-research.semantic.v3'?'comment_research_semantic_v3':packet?.contract==='comment-research.semantic.v4'?'comment_research_semantic_v4':packet?.contract==='comment-research.semantic.v5'?'comment_research_semantic_v5':packet?.contract==='comment-research.semantic.v6'?'comment_research_semantic_v6':packet?.contract==='comment-research.semantic.v1/problem-resolution'?'comment_research_problem_resolution_v1':packet?.contract==='comment-research.semantic.v2/problem-resolution'?'comment_research_problem_resolution_v2':packet?.contract==='comment-research.semantic.v3/problem-resolution'?'comment_research_problem_resolution_v3':packet?.contract==='comment-research.semantic.v4/problem-resolution'?'comment_research_problem_resolution_v4':packet?.contract==='comment-research.semantic.v5/problem-resolution'?'comment_research_problem_resolution_v5':packet?.contract==='comment-research.semantic.v6/problem-resolution'?'comment_research_problem_resolution_v6':null;
