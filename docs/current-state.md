...
本轮 cleanup follow-up 已完成针对性审查与回归，差异经本地核对后提交；Issue #130 旧正文同步与 PR/root 集成审查仍待处理。共享迁移、main 合并、runtime-main 切换、部署、插件重载、外部平台访问和 Mog 业务验收均未执行。浏览器验收见 `docs/design/acceptance/domain-unification-001-acceptance.md`。
