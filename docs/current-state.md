...
| 9 | LOCAL-001 | 独立本地产品、Evidence Library V7 与 Local Canary 路线 | 治理开卡（PR #24 待独立审查） | 001A/001B/001C-1–3 逐张另建 Scope；只解除本地产品路线的历史总禁令，不证明 host、页面、插件、真实数据、媒体或 OCR/ASR 已实现 |
