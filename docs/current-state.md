...
| 6 | ARC-001 | 产品与系统架构收口决策图 | 进行中（媒体/采集合同） | `product-shell`、`primary-daily-job`、`first-producer-canary` 已有用户决定；方案 B 使媒体生命周期与采集控制成为真实 Canary 前置门，最后仍由 Mog 批准首个用户可见 SCOPE |
