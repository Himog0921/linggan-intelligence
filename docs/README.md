...
| [`plans/active/plugin-xhs-adaptive-scroll-and-detail-receipt-001.md`](plans/active/plugin-xhs-adaptive-scroll-and-detail-receipt-001.md) | 活跃计划；Issue #80 | 将 XHS 页面加载滚动收敛为可解释的有限过程；分离 Intelligence 详情交付与人工媒体下载，并逐 lane 显示接纳回执 |
