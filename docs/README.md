...
| [plans/active/comment-research-output-diagnostics-001.md](plans/active/comment-research-output-diagnostics-001.md) | 活跃计划；Issue #258 | 将 V4 模型输出失败拆为安全且可行动的阶段诊断，并将问题归并示例绑定到真实候选集 |
