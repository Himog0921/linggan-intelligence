...
| [`plans/active/real-xhs-search-discovery-001.md`](plans/active/real-xhs-search-discovery-001.md) | Draft PR 实施中 | Issue #48：把已接纳的完整 Linggan-owned 插件中成熟 XHS 搜索页卡片读取能力，接入 LOCAL_TRUSTED outbox、真实 discovery Coverage 与 Evidence Library；禁止真实访问直到独立审查和合并 |
