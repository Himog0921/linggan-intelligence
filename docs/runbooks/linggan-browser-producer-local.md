...
构建检查本身不证明插件已加载、工位已认领、Package 已接纳或 Evidence UI 已读取。历史 `0.8.28` 有一笔标准详情真实链，但仍不证明小红书全平台总量/趋势、所有筛选搜索、所有作者页、真实非空评论图片、长期稳定性或未实测媒体/处理组合；也不证明 `0.8.35` 候选已经在真实 Chrome 或平台生效。
