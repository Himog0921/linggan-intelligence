...
| [pages/domain-management-page.md](pages/domain-management-page.md) | PAGE-DOMAIN-MANAGEMENT-001：Domain、Target 用途、状态后果和材料 lane | 权威当前；隔离交互与本机部署后浏览器 smoke 已验证，业务验收待办 |
...
| [changes/domain-unification-001-ui-change-manifest.md](changes/domain-unification-001-ui-change-manifest.md) | DOMAIN-UNIFICATION-001：平级 Domain 与统一材料链 UI 变更清单 | 权威当前；本机部署后 smoke 已验证，业务验收待办 |
| [acceptance/domain-unification-001-acceptance.md](acceptance/domain-unification-001-acceptance.md) | ACC-DOMAIN-UNIFICATION-001：领域管理页隔离交互验收及本机部署后 smoke 补充 | 一次性报告 |
...
## COMMENT-RESEARCH-PROBLEM-RESOLUTION-V2 交付分支
