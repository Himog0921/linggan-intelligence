...
const DouyinAdapter = {
  ...
  init() {
    ...
    // Legacy API capture source is retained, but no page-context interception
    // runs until Linggan has a matching, reviewed adapter contract.
    ...
    // 保留旧分享采集源码以便后续 adapter 接通时复用；当前不绑定，避免任何自动平台访问。
