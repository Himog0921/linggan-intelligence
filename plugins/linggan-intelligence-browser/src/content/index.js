...
async function assertPluginAuthorized() {
  return assertLingganCapability('platform_collection');
}
...
function initXhsPage() {
  // The legacy bridge is preserved in source but is not started before the
  // corresponding Linggan collection contract is available.
