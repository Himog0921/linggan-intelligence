...
case "$request" in
  ...
  *SETTLEMENT_QUOTE_VALID*)
    printf '%s' '{"version":"linggan.pi.v1/0.85.1","ok":true,"text":"{\"outcome\":\"atoms\",\"atoms\":[{\"kind\":\"problem\",\"proposition\":\"孩子存在作业持续拖延\",\"basis\":\"explicit\",\"evidence\":\"孩子写作业总是拖延\"}]}","failureCode":null,"modelIds":null,"modelListOrigin":null,"usage":{"inputTokens":null,"outputTokens":null,"costUsd":null},"elapsedMs":1}'
    ;;
  *SETTLEMENT_OFFSET_UNMAPPABLE*)
    printf '%s' '{"version":"linggan.pi.v1/0.85.1","ok":true,"text":"{\"outcome\":\"atoms\",\"atoms\":[{\"kind\":\"problem\",\"proposition\":\"synthetic offset proof\",\"basis\":\"explicit\",\"evidence\":\"SETTLEMENT_OFFSET_UNMAPPABLE\"}]}","failureCode":null,"modelIds":null,"modelListOrigin":null,"usage":{"inputTokens":null,"outputTokens":null,"costUsd":null},"elapsedMs":1}'
    ;;
  *)
    exit 64
    ;;
