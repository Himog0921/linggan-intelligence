...
const EXTRACTION_CONTRACT: &str = "comment-research.semantic.v2/extract:problem,need,solution,experience;output:exact-json-or-single-json-fence";
const MEMBERSHIP_CONTRACT: &str = "comment-research.semantic.v2/membership:retrieval-only-before-decision;output:exact-json-or-single-json-fence";
